...
class SliverHeaderChildDelegateImpl extends SliverPersistentHeaderDelegate {
  ...
  late HomeHeaderBloc _bloc;
  SliverHeaderChildDelegateImpl(){
    _bloc = HomeHeaderBloc()..add(HomeHeaderEvent.init);
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: (_bloc.user?.avatar != null ?
                          NetworkImage(_bloc.user!.avatar!):
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Ma sinh vien: ${_bloc.user?.studentId??""}",
                              style: TextStyle(
                                fontSize: 12,
                              ),
                            ),
                      ...
                      child: Column(
                        ...
                        children: [
                          RichText(text: TextSpan(
                            children: [
                              TextSpan(text: (_bloc.gpa?.gpa.toStringAsFixed(2)??"N/A").toString(),
                                style: TextStyle(
                                  color: AppColor.red,
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold
