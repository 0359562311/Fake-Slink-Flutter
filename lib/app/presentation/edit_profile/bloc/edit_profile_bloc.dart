...
class EditProfileBloc extends Bloc<EditProfileEvent, EditProfileState> {
  ...
  EditProfileBloc(this._updateAvatarUseCase, this._updateProfileUseCase) : super(EditProfileInitState()) {
    on<EditAvatarEvent>(_onUpdateAvatarEvent);
    on<EditProfileIn4Event>(_onUpdateIn4Event);
  }

  FutureOr<void> _onUpdateAvatarEvent(EditAvatarEvent event, Emitter<EditProfileState> emit) async {
  ...
  FutureOr<void> _onUpdateIn4Event(EditProfileIn4Event event, Emitter<EditProfileState> emit) async {
